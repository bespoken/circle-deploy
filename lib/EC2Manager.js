    ...
    static async launchInstance() {
        ...
        const instanceInfo = {
            BlockDeviceMappings: [
               ...
               DeviceName: "/dev/xvda", 
               Ebs: {
                VolumeSize: Config.int("volumeSize",100),
               }
              }
             ], 
            IamInstanceProfile: {
            ...
            ImageId: "ami-00bf0e20ed7ea8cdc", //Config.str("imageId"),
            ...
            SubnetId: Config.str("subnets").toString().split(",")[1], //it only accepts one subnet
            UserData: base64data
        };
